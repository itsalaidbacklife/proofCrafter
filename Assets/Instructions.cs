...
public class Instructions : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            case "0A":
                messages = new string[][] { new string[] { "Let's show that anything in AnB must be in A and B.\nPress 'SPACE' to Continue", "We start with AnB and drag a wire from its terminal\n to the input of the Separate operator.", "Once the operator has input, we can drag the Set A \ninto the output of the operator.", "Once the operator has input, we can drag the Set A \ninto the output of the operator." }, new string[] { "This is the second series of messages"} };
                break;
            case "0B":
                ...
                break;
            case "0C":
                messages = new string[][] { new string[] { "Now, try to split CnD into C and D!"}};
                break;
            case "0E":
                messages = new string[][] { new string[] { "Finally, go ahead and split FnE into E and F.\nWatch out for the other sets!"}};
                break;
            case "1A":
            ...
            case "3A":
                ...
                break;
            case "3B":
                messages = new string[][] { new string[] { "Prove (BnE)nF is a subset of E.\nYou will have to drag the operators into position!" }, new string[] { "This is the second series of messages", "sure is" } };
                break;
            case "5A":
            ...
            case "Cn":
                ...
                break;
            case "flip_tutorial":
                messages = new string[][] { new string[] { "Prove AnB is a subset of BnA\nTry using the new flip operator!" }, new string[] { "This is the second series of messages", "sure is" } };
                break;
            case "flip_tutorial2":
